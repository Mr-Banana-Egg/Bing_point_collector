...
# Coordinates for reward buttons(change if needed)
...
def redeem_rewards():
    #Open Bing Rewards
    pyperclip.copy("https://rewards.bing.com/")
    print("[INFO]: Copied Bing Rewards URL to clipboard.")
    time.sleep(1)
    #Open new tab
    print("[INFO]: Opening new tab.")
    pyautogui.hotkey('ctrl', 't')  
    ...
    # Step 2: Click Reward Buttons
    print("[INFO]: Clicking reward buttons.")
    for coords in reward_button_coords:
        x, y = coords
        print(f"[INFO]: Clicking reward button at ({x}, {y}).")
        #Move the mouse
    ...
    # Scroll down (negative for downward scrolling)
    pyautogui.scroll(-1000)
    time.sleep(1)  

    #Re-Click Secondary Buttons
    print("[INFO]: Clicking secondary reward buttons after scrolling.")
    for coords in secondary_coords:
        x, y = coords
        print(f"[INFO]: Clicking secondary reward button at ({x}, {y}).")
        #Move to button
        pyautogui.moveTo(x, y)  
        #Click button
        pyautogui.click()  
